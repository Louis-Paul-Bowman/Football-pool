	...
	<div class="input-group-shim shadow rounded-lg">
		<div class="flex flex-col w-full items-center space-y-4">
			<TabGroup justify="justify-center">
				...
				{:else}
					<form class="select w-full" method="post" action="?/signup" autocomplete="off">
						<label class="label block">
							<span>Email</span>
							<input
								class="input w-full rounded-lg variant-filled-secondary"
						...
						<label class="label block">
							<span>Display name (shown to others)</span>
							<input
								class="input w-full rounded-lg variant-filled-secondary"
								type="text"
								id="displayName"
						...
						<span class="w-full flex justify-center">
							<button class="btn w-fit rounded-lg variant-outline-secondary">Register</button>
						</span>
					</form>
				{/if}
				</svelte:fragment>
